...
def test_setup(): #setup and clean up after test finished
    ...
    yield #using a 'yield' statement instead of 'return' statement, all the code after the 'yield' statement serves as the teardown code
    driver.close()
    driver.quit()
...
@pytest.mark.skip(reason='test is not in scope of the sprint') #this test should be skipped, reason in brackets could be specified
