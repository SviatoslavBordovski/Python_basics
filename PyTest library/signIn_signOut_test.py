...
def test_setup(): #setup and clean up
    ...
    yield #using an 'yield' statement instead of the 'return' statement, all code would run after a 'yield' statement as teardown
    driver.close()
    driver.quit()
...
@pytest.mark.skip(reason='test is not in scope of the sprint') #this test would be skipped, reason could be specified in the brackets
