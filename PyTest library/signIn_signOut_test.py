...
from lib2to3.pgen2 import driver # line of code which is resolving import errors in VS Code IDE but you can use PyCharm and see zero errors there
...
def test_validLoginLogout(test_setup):
    ...
    x = driver.title
    assert x == 'OrangeHRM' # check for a 'True' title value on the page which should be read from HTML tree
