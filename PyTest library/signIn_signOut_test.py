...
import time
import pytest
import sys #import has strict order, this is a 1st line
...
@pytest.fixture()
def test_setup(): #setup and clean up after the finished test
    ...
    yield #using 'yield' statement instead of a 'return' statement, all code would run after 'yield' statement serves as teardown
    driver.close()
    driver.quit()
