...
class LoginPage():
    ...
    def enter_username(self, username): #function that cleans field and types username in the field with specified id of the element
    ...
    def enter_password(self, password): #function that cleans field and types password in the field with specified id of the element
