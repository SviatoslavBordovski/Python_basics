...
class signInTests(unittest.TestCase):
    ...
    def test_2_invalidLoginLogout(self):
        ...
        #Wrong password specified here to check if validation is working
        ...
        #In case if previous conditions did not match - a program will report a message below through HtmlTestRunner report library
        else:
