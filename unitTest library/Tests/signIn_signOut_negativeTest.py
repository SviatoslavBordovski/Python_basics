...
class signInTests(unittest.TestCase):
    ...
    def test_2_invalidLoginLogout(self):
        ...
        #Wrong password specified here to check if validation is actually working
        ...
        #In case if previous conditions do not match - a program will report a message below through HtmlTestRunner report library
        else:
...
if __name__== '__main__': #This piece of code makes a separate report after every test run in a specified folder
